# qiskit-addon-mpf Coverage Matrix
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| qiskit-addon-mpf | qiskit_addon_mpf | dependency-not-installed | dependency | 0 | Inventory only | qiskit-addons | dependency availability smoke | LOW | Optional dependency is not installed in this environment. |
