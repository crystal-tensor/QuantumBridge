# qiskit-addon-sqd Coverage Matrix
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| qiskit-addon-sqd | qiskit_addon_sqd | dependency-not-installed | dependency | 0 | Inventory only | qiskit-addons | dependency availability smoke | LOW | Optional dependency is not installed in this environment. |
