# qiskit-ibm-runtime Coverage Matrix
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| qiskit-ibm-runtime | qiskit_ibm_runtime | dependency-not-installed | dependency | 0 | Inventory only | qiskit-runtime | dependency availability smoke | LOW | Optional dependency is not installed in this environment. |
