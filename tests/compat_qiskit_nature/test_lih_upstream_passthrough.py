...
from quantumbridge.compat.qiskit_nature import run_lih_upstream_passthrough
from quantumbridge.schema.chemistry_results import UpstreamNatureResult


def test_lih_upstream_passthrough_runs_or_reports_missing_dependency():
    result = run_lih_upstream_passthrough()
