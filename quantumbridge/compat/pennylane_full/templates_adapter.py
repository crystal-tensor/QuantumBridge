...
"""PennyLane templates inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("pennylane", "pennylane", ("pennylane.templates",), "pennylane-full", "pennylane_templates")
