...
"""PennyLane measurements inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("pennylane", "pennylane", ("pennylane.measurements",), "pennylane-full", "pennylane_measurements")
