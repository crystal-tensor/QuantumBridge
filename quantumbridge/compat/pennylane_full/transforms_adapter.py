...
"""PennyLane transforms inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("pennylane", "pennylane", ("pennylane.transforms",), "pennylane-full", "pennylane_transforms")
