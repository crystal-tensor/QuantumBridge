...
"""PennyLane resource inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("pennylane", "pennylane", ("pennylane.resource",), "pennylane-full", "pennylane_resource")
