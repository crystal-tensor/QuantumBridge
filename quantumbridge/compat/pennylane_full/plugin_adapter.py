...
"""PennyLane plugin-adjacent inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("pennylane", "pennylane", ("pennylane.devices",), "pennylane-full", "pennylane_plugins")
