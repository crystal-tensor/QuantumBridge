...
"""Qiskit Experiments tomography inventory scaffold.
...
ADAPTER = EcosystemAdapter("qiskit-experiments", "qiskit-experiments", ("qiskit_experiments.library.tomography",), "qiskit-experiments", "qiskit_experiments_tomography")
