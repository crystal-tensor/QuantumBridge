...
"""Qiskit Experiments calibration inventory scaffold.
...
ADAPTER = EcosystemAdapter("qiskit-experiments", "qiskit-experiments", ("qiskit_experiments.calibration_management",), "qiskit-experiments", "qiskit_experiments_calibration")
