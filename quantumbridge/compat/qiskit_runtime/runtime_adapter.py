...
"""Qiskit IBM Runtime public API inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("qiskit-ibm-runtime", "qiskit-ibm-runtime", ("qiskit_ibm_runtime",), "qiskit-runtime", "qiskit_runtime")
