...
"""Qiskit IBM Runtime job public API scaffold.
...
ADAPTER = EcosystemAdapter("qiskit-ibm-runtime", "qiskit-ibm-runtime", ("qiskit_ibm_runtime",), "qiskit-runtime", "qiskit_runtime_job")
