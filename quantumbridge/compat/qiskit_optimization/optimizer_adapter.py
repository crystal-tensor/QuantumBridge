...
"""Qiskit Optimization algorithm inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("qiskit-optimization", "qiskit-optimization", ("qiskit_optimization.algorithms",), "qiskit-optimization", "qiskit_optimization_optimizer")
