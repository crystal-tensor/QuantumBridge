...
"""Qiskit Optimization converter inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("qiskit-optimization", "qiskit-optimization", ("qiskit_optimization.converters",), "qiskit-optimization", "qiskit_optimization_converter")
