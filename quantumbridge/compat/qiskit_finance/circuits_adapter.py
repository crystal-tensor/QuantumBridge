...
"""Qiskit Finance circuit-library inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("qiskit-finance", "qiskit-finance", ("qiskit_finance.circuit.library",), "qiskit-finance", "qiskit_finance_circuits")
