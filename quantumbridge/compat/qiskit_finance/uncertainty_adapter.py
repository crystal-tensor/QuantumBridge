...
"""Qiskit Finance uncertainty-model inventory scaffold.
...
ADAPTER = EcosystemAdapter("qiskit-finance", "qiskit-finance", ("qiskit_finance.circuit.library",), "qiskit-finance", "qiskit_finance_uncertainty")
