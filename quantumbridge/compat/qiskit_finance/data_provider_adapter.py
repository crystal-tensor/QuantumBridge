...
"""Qiskit Finance data-provider inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("qiskit-finance", "qiskit-finance", ("qiskit_finance.data_providers",), "qiskit-finance", "qiskit_finance_data_provider")
