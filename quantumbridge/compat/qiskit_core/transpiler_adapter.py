...
"""Qiskit transpiler public API inventory and passthrough scaffold.
...
ADAPTER = EcosystemAdapter("qiskit", "qiskit", ("qiskit.transpiler",), "qiskit-core", "qiskit_core_transpiler")
