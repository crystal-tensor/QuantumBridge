...
try:
    ...
    from quantumbridge.schema.experiments_results import (
        CalibrationFitResult,
        ExperimentsComparisonResult,
        ExperimentsResult as NativeExperimentsResult,
        RabiExperimentResult,
        RamseyExperimentResult,
        T1ExperimentResult,
        UpstreamExperimentsResult,
    )
    from quantumbridge.schema.dynamics_results import (
        DephasingMetadataResult,
        DynamicsComparisonResult,
        DynamicsResult as NativeDynamicsResult,
        HamiltonianModelResult,
        SingleQubitDynamicsResult,
        TimeEvolutionResult,
        UpstreamDynamicsResult,
    )
