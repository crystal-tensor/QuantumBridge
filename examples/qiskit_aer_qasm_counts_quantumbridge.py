...
"""Run the QuantumBridge native educational Aer qasm-counts example."""
...
def main() -> None:
    results = run_qasm_counts_example(shots=128, seed=7)
    native = results["native"]
    upstream = results["upstream"]
    print("QuantumBridge native Aer-style qasm counts")
