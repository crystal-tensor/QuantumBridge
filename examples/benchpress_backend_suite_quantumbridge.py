...
"""Run the Stage 10B backend benchmark suite."""
...
from quantumbridge.compat.benchpress.examples import run_backend_suite_example


def main() -> None:
    output = run_backend_suite_example()
